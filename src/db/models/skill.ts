...
import type { legacy_skill_map, legacy_skill_mapId } from './legacy_skill_map';
...
export class skill extends Model<skillAttributes, skillCreationAttributes> implements skillAttributes {
  ...
  // skill hasMany legacy_skill_map via skill_id
  legacy_skill_maps!: legacy_skill_map[];
  getLegacy_skill_maps!: Sequelize.HasManyGetAssociationsMixin<legacy_skill_map>;
  setLegacy_skill_maps!: Sequelize.HasManySetAssociationsMixin<legacy_skill_map, legacy_skill_mapId>;
  addLegacy_skill_map!: Sequelize.HasManyAddAssociationMixin<legacy_skill_map, legacy_skill_mapId>;
  addLegacy_skill_maps!: Sequelize.HasManyAddAssociationsMixin<legacy_skill_map, legacy_skill_mapId>;
  createLegacy_skill_map!: Sequelize.HasManyCreateAssociationMixin<legacy_skill_map>;
  removeLegacy_skill_map!: Sequelize.HasManyRemoveAssociationMixin<legacy_skill_map, legacy_skill_mapId>;
  removeLegacy_skill_maps!: Sequelize.HasManyRemoveAssociationsMixin<legacy_skill_map, legacy_skill_mapId>;
  hasLegacy_skill_map!: Sequelize.HasManyHasAssociationMixin<legacy_skill_map, legacy_skill_mapId>;
  hasLegacy_skill_maps!: Sequelize.HasManyHasAssociationsMixin<legacy_skill_map, legacy_skill_mapId>;
